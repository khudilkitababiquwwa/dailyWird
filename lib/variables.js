...
const numbersDataPromise = fetch("https://github.com/khudilkitababiquwwa/dailyWird/tree/869bab3d6651664440ec5ecbd7e2b45bdede8284/assets/quran/numbers.json", {mode:"same-origin"}).then((e) =>
  e.json()
);
